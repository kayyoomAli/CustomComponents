...
import {GenericStyles} from '../components/GenericStyles'
import {
  NavigationHeader,
...
import {isAndroid, logErrorWithMessage} from '../components/helperFunctions'';
import TimerText from './TimerText';

const RESEND_OTP_TIME_LIMIT = 30; // 30 secs
const AUTO_SUBMIT_OTP_TIME_LIMIT = 4; // 4 secs

let resendOtpTimerInterval: string | number | NodeJS.Timeout | undefined;
let autoSubmitOtpTimerInterval: string | number | NodeJS.Timeout | undefined;
