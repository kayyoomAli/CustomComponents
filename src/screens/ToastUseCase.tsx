...
import Toast, {IToast} from '../components/CustomToast';
import Modal from '../components/CustomModal';

function ToastUseCase(): JSX.Element {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity style={styles.hideButton} onPress={handleVisibleModal}>
